...
let current_users : string[] = ["Ali" , "Taha" , "Fatima" , "Hoorain" , "Aiman"]


//ARRAY OF NEW USERS
let new_users : string[] = ["Aliya" , "Muntaha" , "Ayesha" , "Hoorain" , "Aiman"]
...
new_users.forEach(new_one_user =>{
    ...
    if(our_condition){
        ...
        console.log(`This User Name ${new_one_user} , is availiable`)
    }
})