...
var favoritePlaces = ["Turkey", "Switzerland", "Saudia Arabia", "Neelam Valley", "Hunza Valley"];
console.log("Orignal Order", favoritePlaces);
// print the array in alphabetical order without modifying the original array
console.log("Alphabetical Oder", __spreadArray([], favoritePlaces, true).sort());
...
console.log(" Reverse Alphabetical Oder", __spreadArray([], favoritePlaces, true).sort().reverse());
//show that my array is in its original order
