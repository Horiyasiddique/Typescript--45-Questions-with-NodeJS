...
var guestList = ["Sadia", "Fatima", "Jaweria", "Maheen"];
...
guestList.forEach(function (oneGuest) { return console.log("Asslam o Alaikum ".concat(oneGuest, " I have found a bigger table for dinner would you like to join me ????")); });
...
guestList.forEach(function (oneGuest) { return console.log("Asslam o Alaikum ".concat(oneGuest, " but you are still invited")); });
